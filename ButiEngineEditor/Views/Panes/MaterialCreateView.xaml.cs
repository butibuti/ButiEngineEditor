...
namespace ButiEngineEditor.Views.Panes
{
    public partial class MaterialCreateView : UserControl
    {
        ...
        private void MaterialCreateButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            ((MaterialCreateViewModel)DataContext).CreateMaterial(MaterialNameBox.Text, DiffuseMain.SelectedColor, AmbientMain.SelectedColor, EmissiveMain.SelectedColor, SpecularMain.SelectedColor);
        }
    }
}